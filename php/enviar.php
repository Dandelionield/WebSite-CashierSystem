...
?>
        ...
        <form class="formulario" style="
	    	...
	    	>
				...
				<div class="field" >
					<h3>se ha enviado un codigo a: <br> <i style="color:black;"><?php echo $email; ?></i> <br>Por favor ingrese el codigo aqui</h3>
					<input type="text" placeholder="X X X X X X X" id="code">
				</div>
    
				
				<button style="margin:5px auto;" type="button"  id="sbmt">verificar</button>
                ...
                <script>
                    ...
                    submit.addEventListener("click",()=>{
                        ...
                        if(code== codigo){
                            ...
                            let field= document.querySelector(".formulario");
                            let segundos = 5;
